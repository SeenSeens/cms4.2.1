					...
					<div class="card bg-secondary text-light mb-3">
						<div class="card-boy bg-dark">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="PostTitle" value="<?= $TitleToBeUpdated; ?>" id="title" placeholder="Type title here">
							</div>
							<div class="form-group">
							...
							<div class="form-group mb-1">
								...
								<img src="Uploads/<?= $ImageToBeUpdated; ?>" alt="" width="170px" height="70px" class="img-fluid mb-1">
